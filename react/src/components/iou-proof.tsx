...
class IouProof extends React.Component<IouProofProps, IouProofState> {
  ...
  renderImage() {
    if (this.props.imagePK) {
      ...
      return <ClearIcon id="noProofIcon" />;
    }
  }

  render() {
    return <div id="requestItem">{this.renderImage()}</div>;
  }
}
